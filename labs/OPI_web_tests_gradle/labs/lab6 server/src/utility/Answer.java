...
public class Answer implements Serializable {
    ...
    public static StudyGroup ansStudyGroup(Console console, Integer id) throws AnswerBreak {
        try {
            ...
            Login login = new Login(console, "fgdg");
            StudyGroup studyGroup = new StudyGroup(id, name, coordinates, studentsCount, formOfEducation, semesterEnum, groupAdmin, 1);

            // Сохранение объекта в базу данных
            StudyGroupDAO studyGroupDAO = new StudyGroupDAO();
            studyGroupDAO.saveStudyGroup(studyGroup, login.getUserId());
