...
public class StudyGroup extends Element implements Validatable, Serializable {
    ...
    public StudyGroup(int id, String name, LocalDateTime creationDate, Coordinates coordinates, Long studentsCount, FormOfEducation formOfEducation, Semester semester, Person person, Integer userId) {
        this.id = id;
        this.name = name;
    ...
    public StudyGroup(Integer id, String name, Coordinates coordinates, Long studentsCount, FormOfEducation formOfEducation, Semester semesterEnum, Person groupAdmin, Integer userId) {
        this(id, name, LocalDateTime.now(), coordinates, studentsCount, formOfEducation, semesterEnum, groupAdmin, userId);
    }
    @Override
